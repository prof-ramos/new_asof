...
import { User, Shield, Mail, Lock, Eye, EyeOff, Key, Users } from 'react-feather';
        ...
        <div className="max-w-md mx-auto">
          <div className="text-center mb-10">
            ...
            <p className="text-gray-600 mt-2">
              {isSignedIn 
                ? 'Bem-vindo à sua conta de associado' 
          ...
          {isSignedIn ? (
            <Card>
              <CardHeader className="text-center">
                ...
                <CardTitle className="text-xl">{user?.fullName || user?.emailAddresses[0]?.emailAddress}</CardTitle>
                <CardDescription>Associado desde 2023</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  ...
                  <Button variant="outline" className="w-full" asChild>
                    <Link href="/associado/perfil">Meu Perfil</Link>
                  </Button>
                  <Button variant="outline" className="w-full" asChild>
                    <Link href="/associado/juridico">Consultoria Jurídica</Link>
                  </Button>
                </div>
                
                <div className="mt-6 pt-6 border-t border-gray-200">
                  <Button variant="outline" className="w-full text-gray-600 hover:text-gray-800" asChild>
                    <Link href="/sign-out">Sair da Conta</Link>
                  </Button>
                </div>
              </CardContent>
            </Card>
